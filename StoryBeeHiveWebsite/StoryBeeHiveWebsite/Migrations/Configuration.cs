    ...
    internal sealed class Configuration : DbMigrationsConfiguration<StoryBeeHiveWebsite.Models.StoryContext>
    {
        ...
        protected override void Seed(StoryBeeHiveWebsite.Models.StoryContext context)
        {
            ...
            var comments = new List<Comment>
            {
                ...
                new Comment{CommentId=4, Description="Life is relaxing while reading this story", StoryId=2},
                new Comment{CommentId=5, Description="Life is relaxing while reading this story", StoryId=2},
                new Comment{CommentId=6, Description="Life is relaxing while reading this story", StoryId=3},
                new Comment{CommentId=7, Description="Life is relaxing while reading this story", StoryId=3},
                new Comment{CommentId=8, Description="Life is relaxing while reading this story", StoryId=4},
                new Comment{CommentId=9, Description="Life is relaxing while reading this story", StoryId=4},
                new Comment{CommentId=10, Description="Life is relaxing while reading this story", StoryId=4},
                new Comment{CommentId=11, Description="Life is relaxing while reading this story", StoryId=4},

                new Comment{CommentId=12, Description="Life is relaxing while reading this story", StoryId=5},
                new Comment{CommentId=13, Description="Life is relaxing while reading this story", StoryId=5},
                new Comment{CommentId=14, Description="Life is relaxing while reading this story", StoryId=6},
                new Comment{CommentId=15, Description="Life is relaxing while reading this story", StoryId=6},
                new Comment{CommentId=16, Description="Life is relaxing while reading this story", StoryId=7},
                new Comment{CommentId=17, Description="Life is relaxing while reading this story", StoryId=8},
                new Comment{CommentId=18, Description="Life is relaxing while reading this story", StoryId=9},
                new Comment{CommentId=19, Description="Life is relaxing while reading this story", StoryId=9},
                new Comment{CommentId=20, Description="Life is relaxing while reading this story", StoryId=9},
                ...
                new Comment{CommentId=23, Description="Life is relaxing while reading this story", StoryId=10},
                new Comment{CommentId=24, Description="Life is relaxing while reading this story", StoryId=10},
                new Comment{CommentId=25, Description="Life is relaxing while reading this story", StoryId=10},
                new Comment{CommentId=26, Description="Life is relaxing while reading this story", StoryId=1}
            };
